<?php
$con = new mysqli("localhost", "root", "", "iEducation_main");
// if (mysqli_query($con, "create database iEducation_main")) {
//     echo "Database created successfully";
// } else {
//     echo "Error creating database: " . mysqli_error($con);
// }

mysqli_select_db($con, "iEducation_main");
...
// *********** Home ***************
// $q = "CREATE TABLE IF NOT EXISTS home (
